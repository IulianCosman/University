CREATE OR ALTER PROCEDURE CreateVersionTables
AS
BEGIN
...
CREATE OR ALTER PROCEDURE RevertCreateVersionTables
AS
BEGIN
...
EXEC CreateVersionTables;

EXEC CreateTable 'Test1', 'ID INT PRIMARY KEY, Name VARCHAR(50)';
SELECT * FROM CurrentVersion;
SELECT * FROM VersionHistory	
EXEC AddColumn 'Test1', 'Rating', 'INT';
SELECT * FROM CurrentVersion;
SELECT * FROM VersionHistory;
EXEC ChangeColumnType 'Test1', 'Name','char(10)';
SELECT * FROM CurrentVersion;
SELECT * FROM VersionHistory;
EXEC CreateDefaultConstraint 'Test1', 'Rating', 0;
SELECT * FROM CurrentVersion;
SELECT * FROM VersionHistory;
EXEC CreateDefaultConstraint 'Test1', 'Name', 'test';
SELECT * FROM CurrentVersion;
SELECT * FROM VersionHistory;
EXEC CreateTable 'Test2', 'Id INT PRIMARY KEY, SomeText VARCHAR(40)';
SELECT * FROM CurrentVersion;
SELECT * FROM VersionHistory;
EXEC AddForeignkeyConstraint 'Test1', 'ID', 'Test2', 'Id';
SELECT * FROM CurrentVersion;
SELECT * FROM VersionHistory;
...
EXEC RevertCreateVersionTables;
EXEC RevertCreateTable 'Test1';
EXEC RevertCreateTable 'Test2'; 